...
ba-spec-output/{{YYYY-MM-DD}}__epic-{{epic-slug}}__story-{{story-slug}}__{{feature-slug}}/
  ...
  feature-spec.md
  feature-spec.html
  figma-links.md                  # nếu có Figma input
  evidence/figma-evidence-log.md  # nếu có Figma input
...
Skill không tạo loose files ở thư mục gốc. Đầu ra phải nằm trong một package folder theo mẫu:
...
Nếu có Figma URL, package phải có `figma-links.md` và `evidence/figma-evidence-log.md` chứa link gốc để dev/QA mở lại thiết kế.
