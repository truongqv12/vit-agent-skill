...
Follow the project's existing report naming and location convention. When the
repository defines a reports directory, place the report there with a
descriptive, dated, kebab-case name.

**Example:** `plans/reports/debug-260826-2215-api-500-investigation.md`
